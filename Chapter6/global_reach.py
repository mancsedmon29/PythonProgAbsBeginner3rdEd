...
read_global()
print("Back in the global score, value is still:", value, "\n")

shadow_global()
print("Back in the glocal scopre, value is still:", value, "\n")

change_global()
print("Back in the global score, value has now changed to:", value)
